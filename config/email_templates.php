...
return [
  "created"=>[
      "organization"=>[
          "subject"=>"Submission received by Center for Civic Engagement",
      ...
      "listing"=>[
          "subject"=>"Submission received for CCE Service Listings",
    ...
    "updated"=>[
        "organization"=>[
            "subject"=>"Organization update approved and active in CCE Service Listings",
             "body"=>"<div><h4>Hi {{contact.name}},</h4>
    ...
    "approved"=>[
        "organization"=>[
            "subject"=>"Organization approved and active in CCE Service Listings",
            "body"=>"<div><h4>Hi {{contact.name}},</h4>
        ...
        "listing"=>[
            "subject"=>"New project approved and active in CCE Service Listings",
            "body"=>"<div><h4>Hi {{contact.name}},</h4>
    ...
    "contact_form"=>[
        "organization"=>[
            "subject"=>"Submission sent through CCE Service Listings",
            "body"=>"<div><h4>Hi {{student.first_name}},</h4>
                    <p>Thanks for reaching out to {{organization.name}}. A representative from the organization will follow up with you directly regarding your interest. If you do not receive a response, it would be appropriate to follow up with them once via the email address or phone number listed on their organization profile. If you still do not receive a response, consider looking for other opportunities in the Service Listings that interest you.</p>
                    <p>You may also check out opportunities offered through Center for Civic Engagement programs and initiatives on our <a href='https://www.binghamton.edu/cce/impactbing/index.html'>website</a>.</p>
                    <p>Remember that you should treat any volunteer opportunity with the same level of professionalism you would for a job or internship. Communicate your interest and availability clearly and be respectful of the expertise of the organization’s staff. They can make wonderful mentors and offer valuable advice and recommendations in the future if you cultivate a good relationship from the start of your experience, particularly when you are involved in a long-term volunteer or internship experience.</p>
                    <p>If you have any further questions or issues, feel free to call or email us.</p>
                    <p>Thank you,</p><br>
                    <p>Center for Civic Engagement</p>
                    <p>Binghamton University</p>
        ...
        "listing"=>[
            "subject"=>"Submission sent through CCE Service Listings",
            "body"=>"<div><h4>Hi {{student.first_name}},</h4>
                    <p>Thanks for reaching out to {{organization.name}} regarding your interest in their {{listing.name}} opportunity. A representative from the organization will follow up with you directly regarding your interest. If you do not receive a response, it would be appropriate to follow up with them once via the email address or phone number listed on their organization profile. If you still do not receive a response, consider looking for other opportunities in the Service Listings that interest you.</p>
                    <p>You may also check out opportunities offered through Center for Civic Engagement programs and initiatives on our <a href='https://www.binghamton.edu/cce/impactbing/index.html'>website</a>.</p>
                    <p>Remember that you should treat any volunteer opportunity with the same level of professionalism you would for a job or internship. Communicate your interest and availability clearly and be respectful of the expertise of the organization’s staff. They can make wonderful mentors and offer valuable advice and recommendations in the future if you cultivate a good relationship from the start of your experience, particularly when you are involved in a long-term volunteer or internship experience.</p>
                    <p>If you have any further questions or issues, feel free to call or email us.</p>
                    <p>Thank you,</p><br>
        ...
        "email_from_student_received"=>[
            "listing"=>[
                "subject"=>"Submission received through CCE Service Listings",
                "body"=>"<div><h4>Hi {{name}},</h4>
                     <p>A Binghamton University student recently showed interest in participating in your {{listing_name}} opportunity currently listed in the Center for Civic Engagement Service Listings.</p>
                     <p>You can follow up with them via the following information. If this listing is no longer active, log in via the <a href='{{manage_listing_url}}'>Service Listings management portal</a> and remove it.</p>
                     <p>{{student_name}}</p>
                     <p>{{student_email}}</p>
                     <p>{{student_phone}}</p><br>
            ...
            "organization"=>[
                "subject"=>"Submission received through CCE Service Listings",
                "body"=>"<div><h4>Hi {{name}},</h4>
                     <p>A Binghamton University student recently showed interest in getting involved with your {{org_name}}, which is currently listed in the Center for Civic Engagement Service Listings.</p>
                     <p>You can follow up with them via the following information.</p>
